...
- Volume, brightness, web page kholna, web search
...
**Vision**
- **📷 Photo samjhana** — koi bhi photo bhejo (📷 button se, permission-free
  system Photo Picker se), Maya usme likha hua padhegi (OCR), jo dikh raha
  hai samjhaegi, aur important details (date/number/text) highlight karegi
