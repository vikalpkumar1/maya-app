...
class GeminiService(
    ...
    private fun systemInstruction(): String = """
        ...
        Agar user ne ek se zyada kaam ek saath maange hain ("X karo phir Y karo"),
        toh EK time mein sirf EK ACTION do — pehla step karo, uska result dekhne
        ke baad agla step khud-ba-khud poochha jayega, tab dusra ACTION dena.

        Agar user koi cheez apne phone par karwana chahta hai, apne jawab ke bilkul
        last line mein EXACTLY is JSON format mein ek ACTION line jodo (us line mein
